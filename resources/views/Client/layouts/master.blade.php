...
<link rel="stylesheet" type="text/css" href="{{ asset('Client/css/font-awesome.css') }}" media="all">
<link rel="stylesheet" type="text/css" href="{{ asset('Client/css/simple-line-icons.css') }}" media="all">
...
<link rel="stylesheet" type="text/css" href="{{ asset('Client/css/animate.css') }}" media="all">
<link rel="stylesheet" type="text/css" href="{{ asset('Client/css/flexslider.css') }}" >
<link rel="stylesheet" type="text/css" href="{{ asset('Client/css/jquery-ui.css') }}">
<link href="{{ asset('Client/css/revolution-slider.css') }}" rel="stylesheet">
<link rel="stylesheet" type="text/css" href="{{ asset('Client/css/style.css') }}" media="all">
</head>
                          ...
                          <div class="col-md-4 has-sep hidden-sm">
                            <div class="custom-menu-right">
                              <div class="box-banner menu-banner">
                                <div class="add-right"><a href="#"><img src="images/menu-img4.jpg" alt="html template"></a></div>
                              </div>
                            </div>
                          </div>
                        </div>
                          ...
                          <div class="col-md-4 has-sep hidden-sm">
                            <div class="custom-menu-right">
                              <div class="box-banner media">
                                ...
                                <div class="add-right"><a href="#"><img src="images/menu-img1.jpg" alt="html template"></a></div>
                              </div>
                              <div class="box-banner media">
                                <div class="add-desc">
                                  <h3>Save up to</h3>
                                ...
                                <div class="add-right"><a href="#"><img src="images/menu-img2.jpg" alt="html template"></a></div>
                              </div>
                            </div>
                          </div>
                        </div>
                    ...
                    <div class="wrap-popup column2">
                      <div class="popup">
                        <div class="row">
                          ...
                          <div class="col-sm-12"> <a class="ads1" href="#"><img class="img-responsive" src="images/menu-img3.jpg" alt="html template"></a> </div>
                        </div>
                      </div>
                    </div>
                  </li>
          ...
          <div class="mtmegamenu">
            <ul>
              <li class="mt-root demo_custom_link_cms">
                <div class="mt-root-item"><a href="index-2.html">
                  <div class="title title_font"><span class="title-text">Home</span></div>
                  </a></div>
                <ul class="menu-items col-md-3 col-sm-4 col-xs-12">
                  <li class="menu-item depth-1">
                    <div class="title"> <a href="index-2.html"><span>Home Version 1</span></a></div>
                  </li>
                  <li class="menu-item depth-1">
                    ...
                    <div class="product-item">
                      <div class="item-inner">
                        <div class="product-thumbnail">
                          <div class="icon-sale-label sale-left">Sale</div>
                          <div class="pr-img-area"> <a title="Ipsums Dolors Untra" href="single_product.html">
                            <figure> <img class="first-img" src="images/products/img02.jpg" alt="html template"> <img class="hover-img" src="images/products/img02.jpg" alt="html template"></figure>
                            </a>
                            <button type="button" class="add-to-cart-mt"> <i class="fa fa-shopping-cart"></i><span> Add to Cart</span> </button>
                          </div>
                          <div class="pr-info-area">
                    ...
                    <div class="product-item">
                      <div class="item-inner">
                        ...
                        <div class="product-thumbnail">
                          <div class="icon-sale-label sale-left">Sale</div>
                          <div class="pr-img-area"> <a title="Ipsums Dolors Untra" href="single_product.html">
                            <figure> <img class="first-img" src="images/products/img03.jpg" alt="html template"> <img class="hover-img" src="images/products/img03.jpg" alt="html template"></figure>
                            </a>
                            <button type="button" class="add-to-cart-mt"> <i class="fa fa-shopping-cart"></i><span> Add to Cart</span> </button>
                          </div>
                          <div class="pr-info-area">
...
<script type="text/javascript" src="{{ asset('Client/js/megamenu.js') }}"></script>
<script type="text/javascript">
  var mega_menu = '0';
  </script>
<script type="text/javascript" src="{{ asset('Client/js/mobile-menu.js') }}"></script>
